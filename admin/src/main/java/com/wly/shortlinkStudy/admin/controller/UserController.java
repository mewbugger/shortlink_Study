...
public class UserController {
     ...
     * @return
     */
    @GetMapping("/api/short-link/v1/admin/user/{username}")
     ...
     * @return
     */
    @GetMapping("/api/short-link/v1/admin/actual/user/{username}")
     ...
     * @return
     */
    @PostMapping("/api/short-link/v1/admin/user")
     ...
     * @return
     */
    @PutMapping("/api/short-link/v1/admin/user")
